...
\begin{itemize}
  ...
  \item if \verb|ScriptPurpose| is \verb|Certifying| then the transaction passes unconditionally
  \item if \verb|ScriptPurpose| is \verb|Voting|
        \begin{itemize}
